...
export const ClientsInstallations: React.FC = () => {
  return (
    <section id="clients" className="py-20 lg:py-24 bg-slate-50 border-b border-slate-200 relative overflow-hidden">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
          {CLIENTS.map((client, idx) => (
            <AnimatedSection key={idx} delay={idx * 50}>
              <div
                className="p-5 rounded-2xl bg-white border border-slate-200 hover:border-brand-teal transition-all text-center group shadow-xs hover:shadow-md"
              >
